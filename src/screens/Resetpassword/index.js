      ...
      const Submit = () => {
        if (inbuiltstate.passwordStatus) {
            if (inbuiltstate.confirmpasswordStatus) {
                if (inbuiltstate.password===inbuiltstate.confirmpassword) {
                    Actions.Login()
            }
        else { setState({ ...inbuiltstate, confirmpasswordstatus: false, confirmpasswordError: "Password didn't match.", }) }
        }
    else { setState({ ...inbuiltstate, confirmpasswordstatus: false, confirmpasswordError: "Please enter confirm password.", }) }
  }
  else { setState({ ...inbuiltstate, passwordstatus: false, passwordError: "Please enter password." }) }
}
        ...
        >
            <AppView style={[styles.mainLayout]}>
                ...
                <AppView style={{
                    ...
                    <AppText style={{ fontFamily: ROBOTO_BOLD, color: LIGHT_BROWN, fontSize: RF(18) }} >Reset Password</AppText>
                ...
                <Card cardContainer={styles.adjustCard}>
                    ...
                    <AppView style={[styles.cardHeaderMsgView]}>
                        <AppText style={[styles.cardHeaderMsgTxt]}>{"Please choose a new password for your account."}</AppText>
                    </AppView>
                    <AppView style={[styles.cardHeaderMsgView]}>
                        <AppText style={[styles.cardHeaderMsgTxt]}>{"New Password"}</AppText>
                    </AppView>
                   <AppView>
                   <Input    
                   ...
                   <AppView style={[styles.cardHeaderMsgView]}>
                        <AppText style={[styles.cardHeaderMsgTxt]}>{"Confirm Password"}</AppText>
                    </AppView>
